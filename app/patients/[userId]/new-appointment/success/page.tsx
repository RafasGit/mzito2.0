...
const RequestSuccess = async ({
    ...
    return (
      <div className=" flex h-svh w-svw max-h-svh sm:max-h-screen px-[5%]">
        <div className="success-img">
          ...
          <section className="flex flex-col items-center">
            ...
            <p className="text-sm sm:text-xl">Ensure you complete payment and we&apos;ll be in touch to confirm your appointment.</p>
          </section>
