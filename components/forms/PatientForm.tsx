...
export const PatientForm = ({appointment} : {appointment: Appointment} ) => {
  ...
  return (
    <Form  {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-4 ml-3 sm:ml-0 sm:space-y-10 px-4 sm:px-6 max-w-screen-sm sm:max-w-screen-xl mx-auto w-full">
